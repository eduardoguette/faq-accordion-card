...
Es un challenge tomado desde la pagina de frontendmentor.io 🚀🌟
...
Lo podrás ver o editar aqui CodeSandBox [🔗](https://codesandbox.io/s/github/eduardoguette/testimonials-grid-section)

## Conclusiones:

La elaboración de este proyecto tomó 2 horas aproximadamente. Los objetivos del proyecto incluían el uso de las siguientes tecnologías HTML5, SCSS y JavaScript

#

Este proyecto fue realizado siguiendo las instrucciones del challenge de [Frontendmentor](https://www.frontendmentor.io/challenges/faq-accordion-card-XlyjD0Oam)
